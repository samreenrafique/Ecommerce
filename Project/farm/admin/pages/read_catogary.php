 ...
 <?php 
     ...
     if($kitni_rows > 0 ){
        ...
        while($a = mysqli_fetch_array($execute)){
            ...
            <td><a href='delete.php?idbhaag=$a[0]'><i class='fa-solid fa-delete-left' style='red'></i></a></td>
            <td><a href='update.php?idbhaag=$a[0]'><i class='fa-solid fa-edit' style='color:'red'></i></a></td>
